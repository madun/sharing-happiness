...
export default function Card(props) {
  if (props.size === "lg") {
    return (
      <div
        className="block rounded-lg relative transform transition-all duration-300 scale-100 hover:scale-95 overflow-hidden bg-left"
        style={{
            ...
            <div className="flex w-full items-center text-sm text-gray-300 font-medium">
              ...
              {props.funded && (
                <div className="text-right">
                  ...
                  />{" "} */}
                  <div className="font-bold">{props.funded}</div>
                  <div className="font-normal">Fundend</div>
                </div>
              )}
            </div>
          </div>
